...
const ansBoxes = document.querySelectorAll(".ans-box")
...
ansBoxes.forEach(answerBox =>{
    const questionBtn = answerBox.querySelector("#sign")
    questionBtn.addEventListener("click", e =>{
        ansBoxes.forEach(ansBox =>{
            if (ansBox !== answerBox){
                ansBox.classList.remove("reveal")
            }
        })
        answerBox.classList.toggle("reveal")
    })
})